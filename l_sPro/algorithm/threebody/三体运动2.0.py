...
# 宇宙
background = pygame.image.load(r"3.png")
...
sun = pygame.image.load(r"sun.png")
...
my_font = pygame.font.SysFont("arial", 15)
Mercury = pygame.image.load(r"mercury_bg.png")
...
my_font = pygame.font.SysFont("arial", 15)
spark = pygame.image.load(r"spark_bg.png")
...
my_font = pygame.font.SysFont("arial", 15)
earth = pygame.image.load(r"earth_min_bg.png")
...
my_font = pygame.font.SysFont("arial", 15)
moon = pygame.image.load(r"mercury_bg.png")
...
Mars = pygame.image.load(r"venus_bg.png")
...
Jupiter = pygame.image.load(r"jupiter_min_bg.png")
...
Saturn = pygame.image.load(r"saturn_bg.png")
...
Uranus = pygame.image.load(r"uranus_bg.png")
...
Neptune = pygame.image.load(r"neptune_bg.png")
screen.blit(pygame.transform.scale(Neptune, (27, 27)), (1090, 385))

# 太阳
sun = pygame.image.load(r"sun_bg.png")
...
venus = pygame.image.load(r"venus_bg.png")
...
mouth = pygame.image.load(r"mercury_bg.png")
...
mouth = pygame.image.load(r"jupiter_bg.png")
